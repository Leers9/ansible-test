...
# ==============================================================================
#
# USAGE     :   bash get-hostcpu-ratio.sh [-w <user,system,iowait>] [-c <user,system,iowait>] ( [ -i <intervals in second> ] [ -n <report number> ])
#           
# Exemple: bash get-hostcpu-ratio.sh 
#          bash get-hostcpu-ratio.sh -w 70,40,30 -c 90,60,40
#          bash get-hostcpu-ratio.sh -w 70,40,30 -c 90,60,40 -i 3 -n 5
#----------------------------------------------------------------------------------------
